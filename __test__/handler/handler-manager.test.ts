...
import { withTimeout } from "../../src/handler/utils/with-timeout";

jest.mock("../../src/handler/utils/with-timeout", () => ({
...
describe("HandlerManager", () => {
  ...
  const mockPayload: LogPayload = { message: "test log" } as LogPayload;

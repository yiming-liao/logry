import { BrowserFormatterConfig } from "logry";

export const format1: BrowserFormatterConfig = {
  lineBreaksBefore: 1,
  lineBreaksAfter: 3,
  timestamp: {
...
export const format2: BrowserFormatterConfig = {
  lineBreaksBefore: 1,
  lineBreaksAfter: 2,
  timestamp: {
    cssStyle: `
...
export const format3: BrowserFormatterConfig = {
  lineBreaksBefore: 1,
  lineBreaksAfter: 2,
  timestamp: {
    cssStyle: `
